...
type WorkflowRepository interface {
	// Basic CRUD operations - SIGNATURE UNIFICADA
	...
	// Advanced search - SIGNATURE CORREGIDA
	FindWithPagination(ctx context.Context, filter map[string]interface{}, page, limit int) ([]*models.Workflow, int64, error)
	SearchAdvanced(ctx context.Context, filters WorkflowSearchFilters) ([]*models.Workflow, int64, error)
...
type LogRepository interface {
	...
	// Query operations with unified signatures
	...
	// Statistics and analytics - SIGNATURE CORREGIDA
	GetStats(ctx context.Context, filter LogSearchFilter) (*models.LogStats, error)
	GetStatistics(ctx context.Context, filter map[string]interface{}) (map[string]interface{}, error)

	// Time-based queries
	GetRecentLogs(ctx context.Context, hours int, limit int) ([]*models.WorkflowLog, error)
	GetLogsByDateRange(ctx context.Context, startDate, endDate time.Time, page, pageSize int) ([]*models.WorkflowLog, int64, error)
...
// LogSearchFilter para búsquedas de logs - CORREGIDO
...
// WorkflowSearchFilters para búsquedas de workflows - CORREGIDO
